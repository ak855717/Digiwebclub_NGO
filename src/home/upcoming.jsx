            ...
            <div className="max-w-7xl mx-auto px-4 relative">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8 mb-16">
                    <div className="max-w-2xl">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight leading-tight pr-4">
                    ...
                    <div className="max-w-md flex flex-col items-start lg:items-start gap-6 lg:ml-auto">
                        ...
                        <div className="flex flex-wrap items-center justify-between w-full gap-4">
                            <button className="inline-flex items-center gap-3 bg-[#dc4c3e] hover:bg-[#c94134] text-white pl-6 pr-2 py-2 rounded-xl font-medium transition-colors">

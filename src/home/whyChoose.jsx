      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
          ...
          <div className="relative w-full max-w-[500px] mx-auto lg:mx-0 h-[550px] lg:h-[650px]">
            ...
            <img
              src={image4}
              className="absolute bottom-0 right-0 w-[48%] h-[38%] object-cover rounded-4xl z-30 shadow-lg border-8 border-[#FAFAFA]"
              alt="EKDKN Activity"
            />
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="bg-white rounded-4xl p-3 lg:p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-8 flex flex-col sm:flex-row gap-8 items-center border border-gray-50">

      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-7 xl:col-span-8">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              {/* Service Item 1 */}
              <div className="p-4 md:p-8 md:pl-0 border-b border-gray-100 md:border-r">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Education Support Programs</h3>
                <p className="text-gray-500 text-sm leading-relaxed mb-6">
                  We offer scholarship, school supply distribution, digital learning access & mentorship.
                </p>
              ...
              <div className="p-4 md:p-8 border-b border-gray-100">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Emergency & Disaster Relief</h3>
                <p className="text-gray-500 text-sm leading-relaxed mb-6">
                  Our healthcare initiatives include free medical camps, health check-ups, and other services.
                </p>
                <a href="#" className="inline-flex items-center gap-2 font-bold text-slate-900 text-sm hover:text-[#DF4A43] transition-colors group">
                  Read More <ArrowUpRight className="w-4 h-4 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" />
                </a>
              ...
              {/* Service Item 3 */}
              <div className="p-4 md:p-8 md:pl-0 border-b md:border-b-0 border-gray-100 md:border-r">
                <div className="w-14 h-14 bg-[#DF4A43] rounded-full flex items-center justify-center text-white mb-6 shadow-md shadow-[#DF4A43]/20">
                   <PackagePlus className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-3">Food & Nutrition Assistance</h3>
                <p className="text-gray-500 text-sm leading-relaxed mb-6">
                  Through food drives & nutrition programs we distribute essential groceries.
                </p>
                <a href="#" className="inline-flex items-center gap-2 font-bold text-slate-900 text-sm hover:text-[#DF4A43] transition-colors group">
                  Read More <ArrowUpRight className="w-4 h-4 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" />
                </a>
              ...
              <div className="p-4 md:p-8">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Shelter & Housing Support</h3>
                <p className="text-gray-500 text-sm leading-relaxed mb-6">
                  We assist vulnerable families with emergency shelter kits, housing repairs.
                </p>
                <a href="#" className="inline-flex items-center gap-2 font-bold text-slate-900 text-sm hover:text-[#DF4A43] transition-colors group">
                  Read More <ArrowUpRight className="w-4 h-4 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" />
                </a>
          ...
          <div className="lg:col-span-5 xl:col-span-4 h-full">
            <div className="bg-[#1e2433] rounded-3xl p-10 h-full min-h-[420px] flex flex-col items-center justify-center text-center relative overflow-hidden shadow-xl">
              ...
              {/* Background graphic - placeholder gradient image */}
              <div 
        ...
        <div className="mt-20 text-center flex flex-wrap items-center justify-center gap-3">
           ...
           <p className="text-gray-500 font-medium text-[15px]">
             Let's make something great work together. <a href="#" className="text-[#DF4A43] font-bold underline decoration-2 underline-offset-4 hover:text-[#c23d3d] transition-colors">Get Free Quote</a>
           </p>
        </div>
